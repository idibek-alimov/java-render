...
import maryam.dto.order.ItemCreateDto;
...
public class ItemService {
    ...
    public List<Item> addItems(List<ItemCreateDto> items, Order order) throws RuntimeException {
...
//            }
    ...
    public List<Item> getDeliveries(){
        return itemRepository.getDeliveries();
    }
